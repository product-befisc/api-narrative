                ...
                <CardContent className="space-y-3">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-semibold text-foreground">{response.name}</p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">Guardian Name</p>
                      <p className="font-semibold text-foreground">{response.guardian_name}</p>
                    </div>
                    <div className="md:col-span-2">
                      <p className="text-sm text-muted-foreground">UAN Number</p>
                      <p className="font-semibold text-foreground">{response.uan}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                      ...
                      <Card key={index} className="border-2">
                        <CardContent className="pt-6">
                          <div className="flex items-start justify-between mb-4">
                            <div>
                              <h4 className="font-semibold text-lg text-foreground">{job.establishment_name}</h4>
                              <p className="text-sm text-muted-foreground">{job.member_id}</p>
                            </div>
                            {!job.date_of_exit && (
