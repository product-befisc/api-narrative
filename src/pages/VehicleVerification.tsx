            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex flex-col items-end gap-2 min-w-[200px]">
                ...
                <div className="flex flex-col items-end gap-1.5">
                  <span className="text-sm font-medium text-foreground/80">RC Advance</span>
                  <span className="text-sm font-medium text-foreground/80">Challan Details</span>
                  <span className="text-sm font-medium text-foreground/80">Chassis to RC</span>
                </div>
              </div>
            </div>
          </div>
